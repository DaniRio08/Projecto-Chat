...
public class User {
	...
	public String toString() {
		return "User [user=" + user + ", mail=" + mail + ", pass=" + pass + ", codeCountry=" + codeCountry
				+ ", session=" + session + ", lastLog=" + lastLog + "]";
	}
	...
	public boolean login() {
		...
		if (this.getUser() != null) {
			...
			System.out.println("Credenciales incorrectas, no se ha encontrado al usuario");
		}
		conBD.close();
		return resposta;
	}
